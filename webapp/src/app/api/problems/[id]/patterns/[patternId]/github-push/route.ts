...
export async function POST(
  ...
  try {
    ...
    const { id: problemIdStr, patternId: patternIdStr } = params;
    ...
    // Guess language extension based on code heuristic (simplified)
    ...
    try {
      ...
      if (body.customFolderName) {
        customFolderName = body.customFolderName;
      }
    } catch (e) {
